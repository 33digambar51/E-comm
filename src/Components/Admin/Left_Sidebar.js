            ...
            <nav id="sidebar">
                ...
                <div class="nav-list">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <Link to="/orders" class="nav-link text-white" title="Orders"><i class="fa fa-image mr-2"></i><span>Orders</span></Link>
                        </li>
                        <li class="nav-item">
                            <Link data-toggle="collapse" data-target="#hotnot" class="nav-link text-white" routerLink="/" title="Orders"><i class="fa fa-music mr-2"></i><span>Collapse</span></Link>
                        ...
                        <li class="nav-item">
                            <Link to="/users_list" class="nav-link text-white" title="User's List"><i class="fa fa-users mr-2"></i><span>User's</span></Link>
                        </li>
                        <li class="nav-item">
